...
const STAT_FORMAT = "%d %s %c %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d"

// Stat struct to store the state of a pid. (RHEL 6)
type Stat struct {
	Pid         int
	Command     string
	State       rune
